// Reference list of countries used for:
//  1. populating the "country" picker when adding a place
//  2. matching a user's saved country name against the name property
//     found in the world boundaries GeoJSON (different datasets spell
//     some country names differently, hence the `aliases` field)
//
// code  = ISO 3166-1 alpha-2 (also used to fetch per-country state/province
//         boundaries, see lib/geo.js)
// code3 = ISO 3166-1 alpha-3
...
export const COUNTRIES = [
  ...
  { code: 'CG', code3: 'COG', name: 'Congo', aliases: ['Republic of the Congo', 'Congo-Brazzaville'] },
  { code: 'CR', code3: 'CRI', name: 'Costa Rica' },
  { code: 'HR', code3: 'HRV', name: 'Croatia' },
  { code: 'CU', code3: 'CUB', name: 'Cuba' },
  { code: 'CY', code3: 'CYP', name: 'Cyprus' },
  { code: 'CZ', code3: 'CZE', name: 'Czechia', aliases: ['Czech Republic'] },
  {
    code: 'CD',
    code3: 'COD',
    name: 'Democratic Republic of the Congo',
    aliases: ['DR Congo', 'Congo-Kinshasa', 'Congo, Dem. Rep.'],
  },
  ...
  { code: 'SZ', code3: 'SWZ', name: 'Eswatini', aliases: ['Swaziland'] },
  ...
  { code: 'CI', code3: 'CIV', name: "Cote d'Ivoire", aliases: ['Ivory Coast'] },
  ...
  { code: 'MM', code3: 'MMR', name: 'Myanmar', aliases: ['Burma'] },
  ...
  { code: 'RU', code3: 'RUS', name: 'Russia', aliases: ['Russian Federation'] },
  ...
  { code: 'KR', code3: 'KOR', name: 'South Korea', aliases: ['Korea', 'Republic of Korea'] },
  ...
  { code: 'TR', code3: 'TUR', name: 'Turkey', aliases: ['Turkiye'] },
  ...
  { code: 'US', code3: 'USA', name: 'United States', aliases: ['United States of America', 'USA'] },
  { code: 'UY', code3: 'URY', name: 'Uruguay' },
  { code: 'UZ', code3: 'UZB', name: 'Uzbekistan' },
  { code: 'VU', code3: 'VUT', name: 'Vanuatu' },
  { code: 'VA', code3: 'VAT', name: 'Vatican City' },
...
export function findCountryByName(input) {
